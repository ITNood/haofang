    ...
    <el-container>
      ...
      <el-header height="70px" style="text-align:right">
          <el-input placeholder="请输入内容" v-model="search" class="input-with-select">
           ...
           <!--提醒中心-->
          <el-popover placement="bottom" trigger="click" class="zindex" popper-class="popverClass">
            <div class="openNews">
              <h5>提醒中心</h5>
              <div class="newlist">
                <router-link :to="{path:'/main',query:{id:item.id}}" v-for="item in items" :key="item.id">
                  <img :src="item.img">
              ...
              <el-button slot="reference" class="el-icon-message-solid popovericon"><el-badge :value="total" class="bageItem"></el-badge></el-button>
          </el-popover>
          <!--消息中心-->
          <el-popover placement="bottom" trigger="click" class="zindex" popper-class="popverClass">
            <div class="openNews">
              ...
              <el-button slot="reference" class="icon iconfont icon-news popovericon"><el-badge :value="total2" class="bageItem"></el-badge></el-button>
          </el-popover>
          <!--预警中心-->
          <el-popover placement="bottom" trigger="click" class="zindex" popper-class="popverClass">
            <div class="openNews">
              ...
              <el-button slot="reference" class="icon iconfont icon-warning popovericon"><el-badge :value="total3" class="bageItem"></el-badge></el-button>
          </el-popover>
          <el-dropdown>
            <span class="el-dropdown-link" style="color:#858796; font-weight:600">
  ...
  data() {
    return {
      ...
      items:[
        ...
        {id:3,img:require('../assets/HoFan_Logo.jpg'),date:'2021-08-10',text:'这是一个新的消息'}
      ],
      news:[
        {id:1,img:require('../assets/HoFan_Logo.jpg'),date:'2021-08-10',text:'这是一个新的消息'},
        {id:2,img:require('../assets/HoFan_Logo.jpg'),date:'2021-08-10',text:'这是一个新的消息'},
