  ...
  <div>
    ...
    <el-row :gutter="20" class="form">
      <el-form :model="searchForm" ref="searchForm">
        ...
        <el-col :md="8" :lg="8" :xl="4">
          <el-row :gutter="15">
            <el-col :span="8">
              <el-button class="el-icon-s-open screen" size="medium" @click="screen">&nbsp;&nbsp;筛选</el-button>
            </el-col>
            <el-col :span="8">
              <el-button class="el-icon-refresh-right road" size="medium" @click="reload">&nbsp;&nbsp;刷新</el-button>
            </el-col>
            <el-col :span="8">
              <el-button class="el-icon-delete-solid delete" size="medium" @click="resetForm('searchForm')" style="line-height:18px">&nbsp;&nbsp;清空</el-button>
            </el-col>
          </el-row>
        </el-col>
    ...
    <el-tabs v-model="activeName" class="tabs" @tab-click="count">
        <el-tab-pane label="广告活动指标" name="1">
          <el-row :gutter="20">
            <el-col :md="8" :lg="6" :xl="4" v-for="(item,index) in card" :key="index">
              <el-card class="card">
        ...
        <el-tab-pane label="销售数据指标" name="2">
          <el-row :gutter="20">
            <el-col :md="8" :lg="6" :xl="4" v-for="(item,index) in market" :key="index">
              <el-card class="card">
                <i @click="closeCard(item.id)" class="el-icon-circle-close"></i>
                <div slot="header" class="clearfix">
                  <span>{{item.chineseName}} {{item.chineseName && item.columns?'|':''}} {{item.columns}}</span>
              ...
              <el-form :model="form" ref="form">
                <ul class="formlist">
                  ...
                  <li>
                    ...
                    <el-select v-model="form.comparisonPeriod" placeholder="请选择">
                      <el-option v-for="item in time"  :key="item.id" :label="item.name" :value="item.id"></el-option>
                    </el-select>
                    <el-button class="el-icon-check plot" @click="newCharts()">生成图表</el-button>
                  </li>
                  <li>
                    <el-row :gutter="30">
                      <el-col :span="12">
                        <el-button size="medium" class="plotBtn" @click="submitImpAndClk">Imp vs Clk</el-button>
                      </el-col>
                      <el-col :span="12">
                        <el-button size="medium" class="plotBtn" @click="submitCostAndSale">Cost VS Sale</el-button>
                      </el-col>
                    </el-row>
                  </li>
                  <li>
      ...
      <el-tab-pane lazy label="指标排序表" name="1">
        <el-row :gutter="20">
                  ...
                  <ul class="formlist tableForm">
                    <li>
                      <el-button size="medium">排序指标</el-button>
                        <el-select v-model="campaignForm.orderName" placeholder="请选择" class="campaign">
                          <el-option v-for="item in  sorts" :key="item.id" :label="item.name" :value="item.id"></el-option>
                        </el-select>
                      <el-radio-group class="selectRadio" v-model="campaignForm.orderAreAsc" size="medium">
                    ...
                    <li>
                        ...
                        <el-radio-group v-model="campaignForm.findRows" class="selectPage">
                    ...
                    <li>
                      <el-button size="medium">对比指标1</el-button>
                      <el-select v-model="campaignForm.norm" placeholder="请选择" class="selectPage" @change="changenorm1">
                        <el-option v-for="item in sorts" :key="item.id" :label="item.name" :value="item.id"></el-option>
                      </el-select>
                    </li>
                    <li>
                      <el-button size="medium">对比指标2</el-button>
                      <el-select v-model="campaignForm.norm1" placeholder="请选择" class="selectPage" @change="changenorm2">
                        <el-option v-for="item in sorts" :key="item.id" :label="item.name" :value="item.id"></el-option>
                      </el-select>
                    </li>
                    <li>
                      <el-button size="medium">对比指标3</el-button>
                      <el-select v-model="campaignForm.norm2" placeholder="请选择" class="selectPage" @change="changenorm3">
                        <el-option v-for="item in sorts" :key="item.id" :label="item.name" :value="item.id"></el-option>
                      </el-select>
                    </li>
                    <li>
                      <el-button size="medium">对比指标4</el-button>
                      <el-select v-model="campaignForm.norm3" placeholder="请选择" class="selectPage" @change="changenorm4">
                        <el-option v-for="item in sorts" :key="item.id" :label="item.name" :value="item.id"></el-option>
                      </el-select>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                      <el-button class="el-icon-s-open preparation" @click="submitCampaignForm">&nbsp;&nbsp;筛选 | 广告活动</el-button>
                    </li>
                  </ul>
                </el-form>
              </el-col>
          ...
          <el-col :sm="24" :md="24" :lg="24" :xl="12">
            <el-row :gutter="20">
              <el-col :sm="14" :md="14" :xl="16" :lg="16">
                <el-table v-if="hasData" :data="tableData1" border max-height="426" :header-cell-style="{background:'#858796',color:'#fff'}">
                    <el-table-column label="广告关键词" prop="keywordText" min-width="200"></el-table-column>
                    <el-table-column label="ACoS" prop="acos"></el-table-column>
                    <el-table-column label="点击量" prop="clicks"></el-table-column>
                    <el-table-column label="广告花费" prop="cost"></el-table-column>
                    <el-table-column label="曝光量" prop="impressions"></el-table-column>
                    <el-table-column label="点击率" prop="ctr"></el-table-column>
                    <el-table-column label="订单量" prop="orders"></el-table-column>
                </el-table>
                <el-table v-else :data="tableData1" border max-height="426" :header-cell-style="{background:'#858796',color:'#fff'}">
                  <el-table-column v-for="(item,index) in columns" :key="index" :prop="item.prop" :label="item.name" :min-width="item.width" :show-overflow-tooltip="true" ></el-table-column>
                </el-table>
              </el-col>
              <el-col :sm="10" :md="10" :xl="8" :lg="8">
                <el-form :model="campaignForm1" ref="campaignForm1">
                  <ul class="formlist tableForm">
                    <li>
                      <el-button size="medium">排序指标</el-button>
                        <el-select v-model="campaignForm1.sortField" placeholder="请选择" class="campaign">
                          <el-option v-for="item in sorts" :key="item.id" :label="item.name" :value="item.id"></el-option>
                        </el-select>
                      <el-radio-group class="selectRadio" v-model="campaignForm1.sortRule" size="medium">
                    ...
                    <li>
                        <el-button size="medium">显示条数</el-button>
                        <el-radio-group v-model="campaignForm1.row" class="selectPage">
                          <el-radio-button label="5"></el-radio-button>
                          <el-radio-button label="10"></el-radio-button>
                          <el-radio-button label="15"></el-radio-button>
                          <el-radio-button label="20"></el-radio-button>
                    ...
                    <li>
                      ...
                      <el-select v-model="campaignForm1.type" placeholder="请选择" class="selectType">
                        <el-option v-for="item in typeed1" :key="item.id" :label="item.name" :value="item.id"></el-option>
                      </el-select>
                      <el-select v-model="campaignForm1.matchType" placeholder="请选择" class="selectType">
                        <el-option v-for="item in typeed2" :key="item.id" :label="item.name" :value="item.id"></el-option>
                      </el-select>
                    </li>
                    <li>
                      <el-button size="medium">对比指标1</el-button>
                      <el-select v-model="campaignForm1.comparisonIndexOne" placeholder="请选择" class="selectPage">
                        <el-option v-for="item in sorts" :key="item.id" :label="item.name" :value="item.id"></el-option>
                      </el-select>
                    </li>
                    <li>
                      <el-button size="medium">对比指标2</el-button>
                      <el-select v-model="campaignForm1.comparisonIndexTwo" placeholder="请选择" class="selectPage">
                        <el-option v-for="item in sorts" :key="item.id" :label="item.name" :value="item.id"></el-option>
                      </el-select>
                    </li>
                    <li>
                      <el-button size="medium">对比指标3</el-button>
                      <el-select v-model="campaignForm1.comparisonIndexThree" placeholder="请选择" class="selectPage">
                        <el-option v-for="item in sorts" :key="item.id" :label="item.name" :value="item.id"></el-option>
                      </el-select>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                      <el-button class="el-icon-s-open preparation" @click="submitPoster">&nbsp;&nbsp;筛选 | 广告关键词</el-button>
                    </li> 
                  </ul>
                </el-form>
              </el-col>
        ...
        <el-row :gutter="20">
          <el-col :md="16" :lg="16" :xl="19">
            ...
            <el-table :data="posterData" border show-summary :summary-method="getNumber" :header-cell-style="{background:'#858796',color:'#fff'}" id="tableId">
              ...
              <el-table-column sortable label="点击量" prop="clicks"></el-table-column>
              <el-table-column sortable label="点击率" prop="CTR">
                <template slot-scope="scope">
                  {{scope.row.CTR}}%
                </template>
              </el-table-column>
              <el-table-column sortable label="花费" prop="cost"></el-table-column>
              <el-table-column sortable label="CPC" prop="CPC"></el-table-column>
              <el-table-column sortable label="订单量" prop="orders"></el-table-column>
              <el-table-column sortable label="销售额" prop="sales"></el-table-column>
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <el-button @click="copyPoster(scope.row)" size="mini" type="primary">复制</el-button>
                </template>
              </el-table-column>
            </el-table>
      ...
      <el-tab-pane label="广告类型" name="2">
        <el-row :gutter="20">
          <el-col :md="16" :lg="16" :xl="19">
            ...
            <el-table :data="posterTyle" border show-summary :summary-method="sumPosterType" :header-cell-style="{background:'#858796',color:'#fff'}" id="tableId2">
              <el-table-column label="类型" prop="adsOverview"></el-table-column>
              <el-table-column sortable label="曝光量" prop="impressions"></el-table-column>
              <el-table-column sortable label="点击量" prop="clicks"></el-table-column>
              <el-table-column sortable label="订单量" prop="orders"></el-table-column>
              <el-table-column sortable label="花费" prop="cost"></el-table-column>
              ...
              <el-table-column sortable label="CVR" prop="CVR"></el-table-column>
              <el-table-column sortable label="CPC" prop="CPC"></el-table-column>
              <el-table-column sortable label="ACoS" prop="ACOS">
                <template slot-scope="scope">
                  {{scope.row.ACOS}}%
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <el-button @click="copyType(scope.row)" size="mini" type="primary">复制</el-button>
                </template>
              </el-table-column>
            </el-table>
        ...
        <el-row :gutter="20">
          <el-col :md="16" :lg="16" :xl="19">
            ...
            <el-table :data="webSite" border show-summary :summary-method="getSite" :header-cell-style="{background:'#858796',color:'#fff'}" id="tableId3">
              ...
              <el-table-column sortable label="点击量" prop="clicks"></el-table-column>
              <el-table-column sortable label="订单量" prop="orders"></el-table-column>
              <el-table-column sortable label="广告花费" prop="cost"></el-table-column>
              <el-table-column sortable label="广告销售额" prop="sales"></el-table-column>
              <el-table-column sortable label="ACoS" prop="ACOS">
                <template slot-scope="scope">
                  {{scope.row.ACOS}}%
                </template>
              ...
              <el-table-column sortable label="花费占比" prop=""></el-table-column>
              <el-table-column sortable label="销售占比" prop=""></el-table-column>
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <el-button @click="copySite(scope.row)" size="mini" type="primary">复制</el-button>
                </template>
              </el-table-column>
            </el-table>
      ...
      <el-tab-pane label="ASIN" name="4">
        <el-row :gutter="20">
          <el-col :md="16" :lg="16" :xl="19">
            ...
            <el-table :data="asinData" border show-summary :summary-method="getAsin" :header-cell-style="{background:'#858796',color:'#fff'}" id="tableId4">
              ...
              <el-table-column sortable label="广告花费" prop="cost"></el-table-column>
              <el-table-column sortable label="广告销售额" prop="sales"></el-table-column>
              <el-table-column sortable label="商品销售额" prop=""></el-table-column>
              <el-table-column sortable label="ACoS" prop="ACOS">
                <template slot-scope="scope">
                  {{scope.row.ACOS}}%
                </template>
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <el-button @click="copyAsin(scope.row)" size="mini" type="primary">复制</el-button>
                </template>
              </el-table-column>
            </el-table>
...
export default {
  ...
  methods:{
    ...
    //指标排序表
    getresult(data){
      api.post('/adDataStateVB/advertisingCampaign',data).then(res=>{
        if(res.data.length>0){
          this.isData=false
          const data=res.data[0]
          const arr=Object.keys(data)
          const newArr=arr.filter(item=>{return item =="CTR" || item=='cost' || item=='clicks' || item=='impressions' || item=='orders' || item=='acos'})
          let obj = {};
          // 将数组转化为对象
    ...
    getData(data){//广告关键词
      api.post('/adDataStateVB/findKeywords',data).then(res=>{
        if(res.data.length>0){
          ...
          const data=res.data[0]
          const arr=Object.keys(data)
          const newArr=arr.filter(item=>{return item !=="attributedSales14d"})
          let obj = {};
          // 将数组转化为对象
          for (let key in newArr) {
              obj[key] = newArr[key];
    ...
    //广告活动筛选
    getPoster(res){
      api.post('/adDataStateVB/findCampaign',res).then(res=>{
        switch(this.active){
          case '1':
...
              return value2 - value1;
    ...
    //添加规则
    addRules(){
      if(this.conditionForm.value==0 || !this.conditionForm.symbol || !this.conditionForm.metrics){
    ...
    //广告活动复制
    copyPoster(row){
      const data = row.id +' '+ row.clicks +' '+ row.impressions +' '+ row.CVR +' '+ row.CTR+'%' +' '+ row.cost +' '+ row.CPC +' '+ row.orders +' '+ row.sales +' '+ row.ACOS+'%' +' '+ row.ROAS+'%';  //每一行的某个值，如选中的当前行的url
      this.copy(data)
    },
    //广告类型复制
    copyType(row){
      const data=row.adsOverview+' '+row.impressions+' '+row.clicks+' '+row.orders+' '+row.cost+' '+row.sales+' '+row.CTR+'%'+' '+row.CVR+' '+row.CPC+' '+row.ACOS+'%'+' '+row.ROAS+'%'
      this.copy(data)
    },
    //站点复制
    copySite(row){
      const data=row.countryCode+' '+row.impressions+' '+row.impressions+' '+row.clicks+' '+row.orders+' '+row.cost+' '+row.sales+' '+row.ACOS+'%'+' '+row.ROAS+'%'
      this.copy(data)
    },
    copyAsin(row){
      const data=row.asin+' '+row.impressions+' '+row.impressions+' '+row.clicks+' '+row.cost+' '+row.sales+' '+row.ACOS+'%'+' '+row.ROAS+'%'
      this.copy(data)
    },
    //导出广告活动
    exportTable(){
    ...
    getNumber(param){//自定义合计
        ...
        columns.forEach((column, index) => {
          ...
          if(index===columns.length-1){
            sums[index]=<el-button class="export" size="mini" onClick={this.exportTable}>导出</el-button>
            return
          }
    ...
    sumPosterType(param){
      const { columns, data } = param;
        ...
        columns.forEach((column, index) => {
          ...
          if(index===columns.length-1){
            sums[index]=<el-button class="export" size="mini" onClick={this.exportPoster}>导出</el-button>
            return
          }
          const values = data.map(item => Number(item[column.property]));
          if (!values.every(value => isNaN(value))) {
    ...
    getSite(param){
      const { columns, data } = param;
        ...
        columns.forEach((column, index) => {
          ...
          if(index===columns.length-1){
            sums[index]=<el-button class="export" size="mini" onClick={this.exportSite}>导出</el-button>
            return
          }
          const values = data.map(item => Number(item[column.property]));
          if (!values.every(value => isNaN(value))) {
    ...
    getAsin(param){
      const { columns, data } = param;
        ...
        columns.forEach((column, index) => {
          ...
          if(index===columns.length-1){
            sums[index]=<el-button class="export" size="mini" onClick={this.exportAsin}>导出</el-button>
            return
          }
          const values = data.map(item => Number(item[column.property]));
          if (!values.every(value => isNaN(value))) {
