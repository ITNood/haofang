    ...
    <section>
      <el-row :gutter="20">
        <el-col :md="16" :lg="16" :xl="19">
          <div class="operation">
            <el-input placeholder="查找广告组" v-model="content" @keydown.enter.native="submit" clearable style="margin:0">
              <template slot="prepend"><i class="el-icon-search"></i></template>
            </el-input>
            <!--right-->
            <div class="operationRight">
                <el-select placeholder="列/自定义" v-model="column" multiple collapse-tags @change="handlChange" class="selectColumn">
          ...
          <el-table :data="rulesTable" v-loading="loading" ref="rulesTable" id="rulesTable" border :header-cell-style="{background:'#858796',color:'#fff'}" max-height="600">
              ...
              <el-table-column v-for="(item,index) in listColumn" :key="index" :prop="item.prop" :width="item.width" :label="item.name">
